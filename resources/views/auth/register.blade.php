      ...
      <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card card-signin flex-row my-5">
          ...
          <div class="card-body">
            ...
            <form action="{{route('register')}}" method="post" action="" class="form-signin">
                @csrf
              ...
              <hr>
               <div class="form-label-group">
                <input type="phone" id="inputPhone" class="form-control @error('phone') is-invalid @enderror" name="phone" placeholder="phone" required>
              ...
              <div class="form-label-group">
                <input type="password" id="inputConfirmPassword" class="form-control" placeholder="Comfirm Password" name="password_confirmation" required autocomplete="new-password">
