...
@section('admin_content')
     {{--    <div class="wrapper without_header_sidebar">
      ...
      <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white">
        <div class="signin-logo tx-center tx-24 tx-bold tx-inverse">BD MONEY <span class="tx-info tx-normal">Exchange</span></div>
        <div class="tx-center mg-b-60">Money exchange site</div>
